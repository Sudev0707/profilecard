    ...
    <nav class="navbar navbar-dark bg-dark sticky-top">
        ...
        <div class="container-fluid justify-content-center">
            <a class="navbar-brand" href="#">
                <h1 class="d-inline-block align-text-top"> Add Profile </h1>
            </a>
        </div>
    </nav>
                ...
                <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-footer p-2">
                        <div class="button text-center mt-1">
                            <input type="submit" class="btn btn-success w-50" type="button" name="submit_data" value="UPDATE">
                        </div>
                    </div>
                </form>
            </div>
...
if (isset($_POST['submit_data'])) {
    ...
    if ($data) {
        echo "<script> alert(' record addes successfully '); </script>";
    } else {
